      ...
      >
        ...
        <View style={styles.vehicleCards}>
          {Object.entries(VEHICLE_PRICING).map(([key, v]) => (
            ...
            >
              <View style={[styles.vehicleIconBg, vehicleType === key && styles.vehicleIconBgActive]}>
              ...
              <Text style={[styles.vehicleName, vehicleType === key && styles.vehicleNameActive]}>{v.name}</Text>
...
const styles = StyleSheet.create({
  ...
  vehicleCapacity: { fontSize: 11, fontFamily: 'Inter_400Regular', color: Colors.textTertiary, marginTop: 2, textAlign: 'center' },
